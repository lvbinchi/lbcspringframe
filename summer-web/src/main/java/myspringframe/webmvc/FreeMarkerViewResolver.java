...
public class FreeMarkerViewResolver implements ViewResolver {
    ...
    @Override
    public void init() {Configuration cfg = new Configuration(Configuration.VERSION_2_3_29);
        ...
        DefaultObjectWrapper ow = new DefaultObjectWrapper(Configuration.VERSION_2_3_29);
